...
import com.demo.blog.Config.AppConstant;
...
public class PostController 
{
    ...
    {
    	List<PostDto> searchedList= this.postService.searchPost(keyWord);
    	
    	return new ResponseEntity<List<PostDto>>(searchedList,HttpStatus.OK);
    }
	...
	public ResponseEntity<PostDto> uploadImage(@PathParam("image") MultipartFile image,@PathVariable Integer postId) throws IOException
	{
